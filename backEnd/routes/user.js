...
router.post('/createUser', (req, res) => {
    ...
    doesUserExist(userDetail.email, db, (result) => {
        if (result) {
            ...
            createUser(userDetail.id, userDetail.email, userDetail.password, userDetail.phone_num, userDetail.first_name, userDetail.last_name, false, db, (result) => {
                if (result) {
                    res.send(result);
                } else {
...
router.post('/createEmergency', (req, res) => {
    ...
    doesUserExist(userDetail.email, db, (result) => {
        if (result) {
            createEmergencyDetail(userDetail.id, userDetail.email, userDetail.emergency_name, userDetail.emergency_email, userDetail.emergency_phone_num, db, (result) => {
                if (result) {
                    res.send(result);
                } else {
